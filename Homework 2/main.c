...
int main(void) {
    ...
    insert_sell_request(&market, population, people_count, "Charlie", "ALP", 30, 49.0);
    insert_sell_request(&market, population, people_count, "Diana", "ALP", 20, 49.0);

    insert_buy_request(&market, population, people_count, "Alice", "ALP", 60, 48.0);
    insert_buy_request(&market, population, people_count, "Eve", "ALP", 25, 48.0);
    insert_buy_request(&market, population, people_count, "Frank", "ALP", 15, 48.0);

    insert_sell_request(&market, population, people_count, "Grace", "ALP", 10, 49.0);
